...
module.exports = __webpack_require__("xzOm");
...
/* harmony import */ var _hooks_useHomePageRedirect__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("UKuP");
...
function NoCourses() {
  Object(_hooks_useHomePageRedirect__WEBPACK_IMPORTED_MODULE_5__[/* useHomePageRedirect */ "a"])();
  const {
    data
  } = swr__WEBPACK_IMPORTED_MODULE_4___default()("/api/v1/courses/self_enroll_courses", async () => _koh_api_client__WEBPACK_IMPORTED_MODULE_1__[/* API */ "a"].course.selfEnrollCourses());
  return __jsx("div", null, __jsx(antd__WEBPACK_IMPORTED_MODULE_2__["Result"], {
    status: "info",
  ...
  }, "One of our data sources for student-enrollment is currently experiencing an outage. If you think you belong to a class, please click on your corresponding class below.", __jsx("div", null, data === null || data === void 0 ? void 0 : data.courses.map((course, i) => {
    return __jsx(antd__WEBPACK_IMPORTED_MODULE_2__["Button"], {
      key: i,
      onClick: async () => {
        await _koh_api_client__WEBPACK_IMPORTED_MODULE_1__[/* API */ "a"].course.createSelfEnrollOverride(course.id);
