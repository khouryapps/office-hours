...
module.exports = __webpack_require__("X1EG");
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "default", function() { return /* binding */ Apply; });
...
// CONCATENATED MODULE: ./components/Apply/EditCourse.tsx

var __jsx = external_react_default.a.createElement;



const TimezoneCampusMapping = {
...
function EditCourse({
  ...
  const handleSubmitCourse = () => {
    form.validateFields().then(value => onSubmitCourse(value)).catch(() => {// don't submit if the fields are not valid
    });
  };
  ...
  }, "Please fill out the following course information for", " ", __jsx(Highlight, null, sectionGroupString)), __jsx(external_antd_["Form"], {
    form: form,
    layout: "vertical",
  ...
  }, __jsx(external_antd_["Select"], null, Object.entries(TimezoneCampusMapping).map(([timezone, campus]) => __jsx(Option, {
    value: timezone,
    key: timezone
  }, campus)))), __jsx(external_antd_["Form"].Item, {
  ...
  }))), __jsx(external_antd_["Space"], null, __jsx(external_antd_["Button"], {
    onClick: onBack
  }, "Back"), __jsx(external_antd_["Button"], {
    onClick: handleSubmitCourse,
    type: "primary"
  }, "Next")));
}
// CONCATENATED MODULE: ./components/Apply/ConfirmCourses.tsx

var ConfirmCourses_jsx = external_react_default.a.createElement;
...
const FormattedCourseInfo = ({
  label,
  info
}) => ConfirmCourses_jsx("p", {
  style: {
    margin: "0.5em"
  }
}, ConfirmCourses_jsx("b", null, ConfirmCourses_jsx("i", null, label)), info);

const FormattedCourse = ({
  course
}) => ConfirmCourses_jsx("div", {
  style: {
    padding: "0.2em 0"
  }
}, ConfirmCourses_jsx("h3", null, ConfirmCourses_jsx(Highlight, null, createSGString(course))), ConfirmCourses_jsx(FormattedCourseInfo, {
  label: "Course Display Name: ",
  info: course.displayName
}), ConfirmCourses_jsx(FormattedCourseInfo, {
  label: "Campus: ",
...
function ConfirmCourses({
  ...
  return ConfirmCourses_jsx("div", null, courses.length === 0 ? ConfirmCourses_jsx("h3", null, "Continue without registering new courses?") : ConfirmCourses_jsx(external_react_default.a.Fragment, null, ConfirmCourses_jsx("h3", null, "Please confirm all the information is correct before submitting:"), courses.map((course, index) => ConfirmCourses_jsx("div", {
    key: course.name
  }, index > 0 && ConfirmCourses_jsx(external_antd_["Divider"], {
    style: {
      backgroundColor: "#d9d9d9"
    }
  }), ConfirmCourses_jsx(FormattedCourse, {
    course: course
  })))), ConfirmCourses_jsx(external_antd_["Space"], {
    style: {
      marginTop: "1.5em"
    }
  }, ConfirmCourses_jsx(external_antd_["Button"], {
    onClick: onBack
  }, "Back"), ConfirmCourses_jsx(external_antd_["Button"], {
    onClick: onSubmit,
    type: "primary"
  }, "Submit")));
}
...
// CONCATENATED MODULE: ./components/Apply/SelectCourses.tsx
var SelectCourses_jsx = external_react_default.a.createElement;
...
const Italics = external_styled_components_default.a.span.withConfig({
  displayName: "SelectCourses__Italics",
  componentId: "sc-1947xxr-0"
})(["font-weight:normal;font-size:16px;font-style:italic;"]);
const FormSection = external_styled_components_default.a.div.withConfig({
  displayName: "SelectCourses__FormSection",
  componentId: "sc-1947xxr-1"
})(["margin-top:20px;"]);
const CoursesBlock = external_styled_components_default.a.div.withConfig({
...
const LargeTag = external_styled_components_default()(external_antd_["Tag"]).withConfig({
...
function SelectCourses({
  ...
  const profile = Object(useProfile["a" /* useProfile */])(); // populate initially selected courses when returning to first selection page
  ...
  return SelectCourses_jsx("div", null, SelectCourses_jsx("div", null, "It looks like this is your first time using the app for this semester. Please pick out all the courses you want to use Khoury Office Hours for."), SelectCourses_jsx(FormSection, null, SelectCourses_jsx("h3", null, "Courses", " ", SelectCourses_jsx(Italics, null, "(Select all the courses you are applying for)")), SelectCourses_jsx(external_antd_["Select"], {
    mode: "multiple",
  ...
  }, profile === null || profile === void 0 ? void 0 : (_profile$pendingCours2 = profile.pendingCourses) === null || _profile$pendingCours2 === void 0 ? void 0 : _profile$pendingCours2.map((course, idx) => SelectCourses_jsx(external_antd_["Select"].Option, {
    key: course.name,
    value: idx
  }, createSGString(course))))), SelectCourses_jsx(FormSection, null, SelectCourses_jsx("h3", null, "The following courses have already registered for the app:"), SelectCourses_jsx(CoursesBlock, null, profile === null || profile === void 0 ? void 0 : profile.courses.map(course => {
    var _course$course, _course$course2;

    return SelectCourses_jsx(LargeTag, {
  ...
  }))), SelectCourses_jsx(external_antd_["Button"], {
...
// CONCATENATED MODULE: ./components/Apply/ApplyPage.tsx
var ApplyPage_jsx = external_react_default.a.createElement;
...
const ProgressBar = external_styled_components_default()(external_antd_["Progress"]).withConfig({
  displayName: "ApplyPage__ProgressBar",
  componentId: "dtpg8c-0"
})(["padding-bottom:2.5em;& .ant-progress-inner{border:1px solid #d9d9d9;}"]);
function createSGString({
  name,
  crns
}) {
  return `${name} (CRNs: ${crns.join(", ")})`;
}
const Highlight = external_styled_components_default.a.span.withConfig({
...
function ApplyPage() {
  ...
  const handleSubmitCourses = async () => {
    try {
      await api_client["a" /* API */].course.registerCourses(postBody.map(courseInfo => ({
      ...
      external_antd_["message"].success("Successfully registered courses. Redirecting you to the app...");
      await mutateProfile();
      router_default.a.push("/course/[cid]/today", `/course/${profile.courses[0].course.id}/today`);
    } catch (e) {
  ...
  return ApplyPage_jsx("div", {
    style: {
      padding: "3% 12%"
    }
  }, ApplyPage_jsx("h1", null, "Apply for Khoury Office Hours"), ApplyPage_jsx(ProgressBar, {
    percent: calculateProgress(),
    strokeColor: "#408FEA",
    trailColor: "white",
    strokeWidth: 12
  }), currentCourse < 0 ? ApplyPage_jsx(SelectCourses, {
    onSubmit: handleSelectCourses,
    initialValues: postBody.map(c => c.name)
  }) : currentCourse < postBody.length ? ApplyPage_jsx(EditCourse, {
    courseInfo: postBody[currentCourse],
    onSubmitCourse: handleEditCourse,
    onBack: () => setCurrentCourse(currentCourse - 1)
  }) : ApplyPage_jsx(ConfirmCourses, {
    courses: postBody,
    onSubmit: handleSubmitCourses,
    onBack: () => setCurrentCourse(currentCourse - 1)
  }));
}
// CONCATENATED MODULE: ./pages/apply.tsx
var apply_jsx = external_react_default.a.createElement;




function Apply() {
  return apply_jsx(PageContainer["a" /* StandardPageContainer */], null, apply_jsx(head_default.a, null, apply_jsx("title", null, "Apply | Khoury Office Hours")), apply_jsx(ApplyPage, null));
}
